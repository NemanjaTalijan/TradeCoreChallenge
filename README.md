...
Phase 1: Test Plan
	Test Scope
		...
		- Read technical and business documentation (User stories, Acceptance criteria, Exit criteria, API documentation, DB structure, Environment setup, Security documentation)
		- Setting up automation testing framework
